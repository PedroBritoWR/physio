...
//   const { data: userData } = useSession();
  ...
  return (
    <>
      <div className="flex">
        <div className="pt-1 pr-1 mb-1">
          <UserCircle size={45} color="#000" />
        </div>
        <div className="relative mt-2">
          <div className="flex items-center gap-4">
            {/* Nome, Sobrenome e Dropdown */}
            <a
              ref={trigger}
              onClick={() => setDropdownOpen(!dropdownOpen)} // Dropdown ao clicar no nome ou ícone
            ...
            >
              {/* <span className="text-right">
                ...
                <span className="block text-[12px] text-[#637381] font-medium dark:text-white">
